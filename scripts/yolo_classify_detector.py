...
OUTPUT_RTMP = "rtmp://rtmp/classify/cam"
    ...
    try:
        ...
        while True:
            ...
            if now - last_log_time >= 5:
                ...
                top_class = results[0].names[results[0].probs.top1] if hasattr(results[0], 'probs') else 'N/A'
                print(f"[{int(elapsed)}s] ??? {frame_count} ??FPS: {fps_actual:.1f}, ??: {top_class}")
                last_log_time = now
